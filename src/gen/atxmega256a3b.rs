...
pub const XOSCEN: u8 = 0x8;

/// Bitfield on register `CTRL`
pub const ACCEN: u8 = 0x2;

/// Bitfield on register `CTRL`
pub const RESET: u8 = 0x1;

/// Bitfield on register `CTRL`
pub const HIGHESR: u8 = 0x20;
...
pub const BBBORF: u8 = 0x2;

/// Bitfield on register `STATUS`
pub const XOSCRDY: u8 = 0x8;

/// Bitfield on register `STATUS`
pub const BBPORF: u8 = 0x1;

/// Bitfield on register `STATUS`
pub const BBPWR: u8 = 0x80;
