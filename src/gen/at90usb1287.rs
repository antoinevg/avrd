...
pub const VBUSHWC: u8 = 0x4;

/// Bitfield on register `OTGCON`
pub const VBUSRQC: u8 = 0x1;

/// Bitfield on register `OTGCON`
pub const HNPREQ: u8 = 0x20;

/// Bitfield on register `OTGCON`
pub const SRPSEL: u8 = 0x8;

/// Bitfield on register `OTGCON`
pub const VBUSREQ: u8 = 0x2;

/// Bitfield on register `OTGCON`
pub const SRPREQ: u8 = 0x10;

/// Bitfield on register `OTGIEN`
pub const SRPE: u8 = 0x1;

/// Bitfield on register `OTGIEN`
pub const HNPERRE: u8 = 0x10;

/// Bitfield on register `OTGIEN`
pub const BCERRE: u8 = 0x4;

/// Bitfield on register `OTGIEN`
pub const VBERRE: u8 = 0x2;

/// Bitfield on register `OTGIEN`
pub const STOE: u8 = 0x20;

/// Bitfield on register `OTGIEN`
pub const ROLEEXE: u8 = 0x8;

/// Bitfield on register `OTGINT`
pub const VBERRI: u8 = 0x2;

/// Bitfield on register `OTGINT`
pub const HNPERRI: u8 = 0x10;

/// Bitfield on register `OTGINT`
pub const STOI: u8 = 0x20;

/// Bitfield on register `OTGINT`
pub const ROLEEXI: u8 = 0x8;

/// Bitfield on register `OTGINT`
pub const SRPI: u8 = 0x1;

/// Bitfield on register `OTGINT`
pub const BCERRI: u8 = 0x4;

/// Bitfield on register `OTGTCON`
pub const OTGTCON_7: u8 = 0x80;

/// Bitfield on register `OTGTCON`
pub const VALUE_2: u8 = 0x7;

/// Bitfield on register `OTGTCON`
pub const PAGE: u8 = 0x60;
...
pub const RESET: u8 = 0x2;

/// Bitfield on register `UHCON`
pub const RESUME: u8 = 0x4;

/// Bitfield on register `UHCON`
pub const SOFEN: u8 = 0x1;

/// Bitfield on register `UHIEN`
pub const HSOFE: u8 = 0x20;

/// Bitfield on register `UHIEN`
pub const RXRSME: u8 = 0x10;

/// Bitfield on register `UHIEN`
pub const DDISCE: u8 = 0x2;

/// Bitfield on register `UHIEN`
pub const RSMEDE: u8 = 0x8;

/// Bitfield on register `UHIEN`
pub const DCONNE: u8 = 0x1;

/// Bitfield on register `UHIEN`
pub const RSTE: u8 = 0x4;

/// Bitfield on register `UHIEN`
pub const HWUPE: u8 = 0x40;

/// Bitfield on register `UHINT`
pub const DDISCI: u8 = 0x2;

/// Bitfield on register `UHINT`
pub const RXRSMI: u8 = 0x10;

/// Bitfield on register `UHINT`
pub const RSTI: u8 = 0x4;

/// Bitfield on register `UHINT`
pub const RSMEDI: u8 = 0x8;

/// Bitfield on register `UHINT`
pub const DCONNI: u8 = 0x1;

/// Bitfield on register `UHINT`
pub const UHUPI: u8 = 0x40;

/// Bitfield on register `UHINT`
pub const HSOFI: u8 = 0x20;

/// Bitfield on register `UHWCON`
pub const UIMOD: u8 = 0x80;

/// Bitfield on register `UHWCON`
pub const UVREGE: u8 = 0x1;

/// Bitfield on register `UHWCON`
pub const UVCONE: u8 = 0x10;

/// Bitfield on register `UHWCON`
pub const UIDE: u8 = 0x40;

/// Bitfield on register `UPCFG0X`
pub const PTYPE: u8 = 0xC0;

/// Bitfield on register `UPCFG0X`
pub const PEPNUM: u8 = 0xF;

/// Bitfield on register `UPCFG0X`
pub const PTOKEN: u8 = 0x30;

/// Bitfield on register `UPCFG1X`
pub const PSIZE: u8 = 0x70;

/// Bitfield on register `UPCFG1X`
pub const PBK: u8 = 0xC;

/// Bitfield on register `UPCONX`
pub const PEN: u8 = 0x1;

/// Bitfield on register `UPCONX`
pub const PFREEZE: u8 = 0x40;

/// Bitfield on register `UPCONX`
pub const INMODE: u8 = 0x20;

/// Bitfield on register `UPERRX`
pub const COUNTER: u8 = 0x60;

/// Bitfield on register `UPERRX`
pub const DATAPID: u8 = 0x2;

/// Bitfield on register `UPERRX`
pub const DATATGL: u8 = 0x1;

/// Bitfield on register `UPERRX`
pub const TIMEOUT: u8 = 0x8;

/// Bitfield on register `UPERRX`
pub const PID: u8 = 0x4;

/// Bitfield on register `UPERRX`
pub const CRC16: u8 = 0x10;

/// Bitfield on register `UPIENX`
pub const RXINE: u8 = 0x1;

/// Bitfield on register `UPIENX`
pub const TXOUTE: u8 = 0x4;

/// Bitfield on register `UPIENX`
pub const PERRE: u8 = 0x10;

/// Bitfield on register `UPIENX`
pub const TXSTPE: u8 = 0x8;

/// Bitfield on register `UPIENX`
pub const NAKEDE: u8 = 0x40;

/// Bitfield on register `UPIENX`
pub const RXSTALLE: u8 = 0x2;

/// Bitfield on register `UPINTX`
pub const PERRI: u8 = 0x10;

/// Bitfield on register `UPINTX`
pub const TXOUTI: u8 = 0x4;

/// Bitfield on register `UPINTX`
pub const NAKEDI: u8 = 0x40;

/// Bitfield on register `UPINTX`
pub const TXSTPI: u8 = 0x8;

/// Bitfield on register `UPINTX`
pub const RXSTALLI: u8 = 0x2;

/// Bitfield on register `UPINTX`
pub const RXINI: u8 = 0x1;

/// Bitfield on register `UPRST`
pub const PRST: u8 = 0x7F;

/// Bitfield on register `UPSTAX`
pub const NBUSYK: u8 = 0x3;

/// Bitfield on register `USBCON`
pub const HOST: u8 = 0x40;

/// Bitfield on register `USBCON`
pub const USBE: u8 = 0x80;

/// Bitfield on register `USBCON`
pub const VBUSTE: u8 = 0x1;

/// Bitfield on register `USBCON`
pub const FRZCLK: u8 = 0x20;

/// Bitfield on register `USBCON`
pub const IDTE: u8 = 0x2;

/// Bitfield on register `USBCON`
pub const OTGPADE: u8 = 0x10;

/// Bitfield on register `USBINT`
pub const VBUSTI: u8 = 0x1;

/// Bitfield on register `USBINT`
pub const IDTI: u8 = 0x2;

/// Bitfield on register `USBSTA`
pub const SPEED: u8 = 0x8;

/// Bitfield on register `USBSTA`
pub const VBUS: u8 = 0x1;
