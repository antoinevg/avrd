...
pub const MUX: u8 = 0x3;

/// Bitfield on register `ADMUX`
pub const REFS0: u8 = 0x40;

/// Bitfield on register `ADMUX`
pub const ADLAR: u8 = 0x20;

/// Bitfield on register `BODCR`
pub const BODSE: u8 = 0x1;

/// Bitfield on register `BODCR`
pub const BODS: u8 = 0x2;
...
/// Bitfield on register `LOW`
pub const SUT_CKSEL: u8 = 0xF;

/// Bitfield on register `LOW`
pub const WDTON: u8 = 0x20;

/// Bitfield on register `LOW`
pub const SPIEN: u8 = 0x80;
...
pub const OCF0A: u8 = 0x4;

/// Bitfield on register `TIFR0`
pub const TOV0: u8 = 0x2;

/// Bitfield on register `TIFR0`
pub const OCF0B: u8 = 0x8;

/// Bitfield on register `TIMSK0`
pub const OCIE0A: u8 = 0x4;

/// Bitfield on register `TIMSK0`
pub const TOIE0: u8 = 0x2;

/// Bitfield on register `TIMSK0`
pub const OCIE0B: u8 = 0x8;

/// Bitfield on register `WDTCR`
pub const WDTIF: u8 = 0x80;

/// Bitfield on register `WDTCR`
pub const WDTIE: u8 = 0x40;
